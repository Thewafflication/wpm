...
| REQ-0014.002 | TC-0014 | Automated test and inspection | Planned | TC-0034 package/repository, TC-0036 key/trust, and TC-0037 prerelease-configuration final results produced; remaining mutating-command consistency pending |
